...
public class PlayerUpgradeKitEvent extends BaseUserEvent implements Cancellable
{
    ...
    public PlayerUpgradeKitEvent(@NotNull User user, @NotNull Kit kit, @NotNull KitLevel currentKitLevel, @NotNull KitLevel nextKitLevel)
    {
        super(user);
        this.kit = kit;
